...
define([
        ...
        '../../DataSources/TweetJSONDataSource',
        '../getElement'
    ], function(
        defaultValue,
        defined,
    ...
    // GDIT - Modified to add the ability to read tweetjson files
    function createOnLoadCallback(viewer, file, proxy) {
        return function(evt) {
            ...
            try {
                ...
                } else if (/\.tweetjson$/i.test(fileName)) {
                    dataSource = new TweetJSONDataSource(fileName);
