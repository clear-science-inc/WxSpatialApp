...
define([
    ...
    var CesiumWidget = function(container, options) {
        ...
        try {
            ...
            // GDIT - Change to Cesium source
            //
            //        Commented this code out to add our logo to the bottom of the screen
            //
            //            var cesiumCredit = new Credit('Cesium', cesiumLogoData, 'http://cesiumjs.org/');
            //            creditDisplay.addDefaultCredit(cesiumCredit);
            //
            // GDIT - Change to add the GDIT logo
            //        aded the gdit logo and a button to the bottom of the screen above the
            //        clock.
            //
            // var cesiumCredit = new Credit('GDIT', './resources/icons/gdit_logo.png', 'http://www.gdit.com/');
            // creditDisplay.addDefaultCredit(cesiumCredit);
